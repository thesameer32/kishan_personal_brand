        ...
        {openSuccess && (
          ...
          >
            <motion.div 
              ...
              exit={{y:20,opacity:0}} 
              className="w-full max-w-md rounded-3xl border border-white/10 bg-[#0b1220] p-6"
            ...
            >
              ...
              <div className="mt-5 flex gap-3">
                <button 
                  onClick={() => setOpenSuccess(false)} 
                  className="inline-flex h-11 items-center justify-center px-5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 transition-colors"
                >
                  Close
                </button>
